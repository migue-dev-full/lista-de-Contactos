    ...
    const addContact = (newContact) => {
            ...
            // Verificar si el número de teléfono ya existe ANTES de agregar
            if (contacts.some(contact => contact.phone === newContact.phone )) {
             alert("El número de teléfono ya existe en la lista.");
            return false;
            } else if 

                // verifica si el nombre ya se esta usando
                (contacts.some(contact => contact.name === newContact.name)) {
                alert("El Nombre ya existe en la lista.");
                return false;
                } else {
                // Si el número no existe, agregarlo a la lista
    ...
    //     // Verificar si el nombre  ya existe ANTES de agregar
...
//     // Verificar si el número de teléfono ya existe ANTES de agregar
//     if (contacts.some(contact => contact.telefono === newContact.telefono)) {
//         alert("El número de teléfono ya existe en la lista.");
//         return false;
//     }
