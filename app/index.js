...
contactList.addEventListener('click', e => {
    ...
    if (editBtn) {
        ...
        const li = editBtn.parentElement.parentElement;
            ...
            if (editBtn.classList.contains('editando')){
                ...
                const validName = NAME_REGEX.test(nameEditInput.value); 
                const validPhone = PHONE_REGEX.test(phoneEditInput.value);
            ...
            contactsController.renderContacts(contactList);
                ...
                nameEditInput.addEventListener('input', () => {
                    const validName = NAME_REGEX.test(nameEditInput.value);
                    validateInput(validName, nameEditInput);
                    validateBtn();
                });
    
                phoneEditInput.addEventListener('input', () => {
                    const validPhone = PHONE_REGEX.test(phoneEditInput.value);
                    validateInput(validPhone, phoneEditInput);
                    validateBtn();
                });
            }}
            }
    ...
    //     phoneEditedInput.addEventListener('input', e => {
    //     phoneEditedInput = PHONE_REGEX.test(phoneEditedInput.value);
    //     validateInput(phoneValidation, phoneEditedInput);
    //     validateBtn();
    ...
    //     validateInput(nameValidation, nameEditInput);
    //     validateBtn();
    // })
